...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { email: @submission.email, first_name: @submission.first_name, last_name: @submission.last_name, slogan: @submission.slogan } }
